...
Scenario('Play/pause is synced between audio, video when interacting with audio interface', async function({ I, LabelStudio, AtAudioView, AtVideoView }) {
  LabelStudio.setFeatureFlags({
    fflag_feat_front_dev_2461_audio_paragraphs_seek_chunk_position_short: true,
    ff_front_dev_2715_audio_3_280722_short: true,
    fflag_feat_front_lsdv_3012_syncable_tags_070423_short: true,
...
Scenario('Play/pause is synced between audio, video when interacting with video interface', async function({ I, LabelStudio, AtAudioView, AtVideoView }) {
  LabelStudio.setFeatureFlags({
    fflag_feat_front_dev_2461_audio_paragraphs_seek_chunk_position_short: true,
    ff_front_dev_2715_audio_3_280722_short: true,
    fflag_feat_front_lsdv_3012_syncable_tags_070423_short: true,
...
Scenario('Seeking is synced between audio, video when interacting with audio interface', async function({ I, LabelStudio, AtAudioView, AtVideoView }) {
  LabelStudio.setFeatureFlags({
    fflag_feat_front_dev_2461_audio_paragraphs_seek_chunk_position_short: true,
    ff_front_dev_2715_audio_3_280722_short: true,
    fflag_feat_front_lsdv_3012_syncable_tags_070423_short: true,
