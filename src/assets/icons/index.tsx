...
export { default as IconBrushTool } from './brush-tool.svg';
export { default as IconCircleTool } from './circle-tool.svg';
export { default as IconKeypointsTool } from './keypoints-tool.svg';
export { default as IconPolygonTool } from './polygon-tool.svg';
export { default as IconRectangleTool } from './rectangle-tool.svg';
export { default as IconEraserTool } from './eraser-tool.svg';

export { default as IconMagnifyTool } from './magnify-tool.svg';
export { default as IconMinifyTool } from './minify-tool.svg';
