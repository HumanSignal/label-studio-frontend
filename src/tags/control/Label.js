 ...
 * @param {string} [mandatoryLabel]            - Mandatory Label
 * @param {boolean} [showMandatoryLabel=false] - Whether to show alias inside label text
...
const TagAttrs = types.model({
  ...
  mandatorylabel: types.maybeNull(types.string),
  showmandatorylabel: types.optional(types.boolean, false),
    ...
    const label = (
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center' }}>
          {item.showmandatorylabel === true && item.mandatorylabel && (
            <div
              style={{
                borderWidth: '1px',
                borderStyle: 'solid',
