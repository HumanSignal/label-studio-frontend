...
const VertexModel = types.compose("VertexModel", TagAttrs, Model, ProcessAttrsMixin);

const HtxVertexView = inject("store")(
  observer(({ item, store }) => {
...
Registry.addTag("vertex", VertexModel, HtxVertexView);

export { HtxVertexView, VertexModel };
