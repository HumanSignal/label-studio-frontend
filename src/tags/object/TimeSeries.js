 ...
 * Read more about Time Series Labeling on [the time series template page](../templates/time_series.html).
 *
 * Note: Time axis must be sorted in your samples, otherwise TimeSeries breaks.
 * To use autogenerated indices as time axes, skip the `timeColumn` parameter.
 * @example
 * <!-- csv loaded by url in `value` with 3 columns: time, sensor1, sensor2 -->
 * <!-- key column `time` is a number -->
 * <View>
 ...
 * </View>
 * @example
 * <!-- data stored in task field `ts` in Label Studio JSON format -->
